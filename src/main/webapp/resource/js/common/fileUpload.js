...
function upLoadUserIconInput(ctrlName, uploadUrl, data) {
	var control = $('#' + ctrlName);
	control.fileinput({
		language : 'zh', //设置语言  
		uploadUrl : uploadUrl, //上传地址  
...
//            ],  
		...
		returnUploadedData = data.response;
		$.post(getRootPath()+"/userManage/updateUserIcon.do", {userIconId:data.response}, function(data, textStatus, req) {
