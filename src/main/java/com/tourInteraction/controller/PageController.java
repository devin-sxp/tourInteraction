...
public class PageController {
	...
	@RequestMapping("/backgroundManagementArticleManage")
	public String backgroundManagementArticleManage(HttpServletRequest req){
		return "backgroundManagement/articleManage";
	}
