		...
		if(textStatus == "success"){
			...
			$.each(data.list, function(objIndex, article) {
				var html = "<li><div class=\"content\"><div class=\"author\">"+
						   ...
						   "<a class=\"title\" target=\"_blank\" href=\"\">"+article.articleName+"</a>"+
						   "<p class=\"abstract txt-limit-2\">"+article.articleContent+"</p>"+
						   "<div class=\"meta\"><a><i class=\"iconfont ic-list-read\"></i>"+article.articleLookCount+
						   "</a><a><i class=\"iconfont ic-list-comments\"></i>"+"12"+
						   "</a><span><i class=\"iconfont ic-list-like\"></i>"+article.articleLoveCount+
						   "</span></div></div></li>"
				$(".note-list").append(html);
				articleWordsCount = articleWordsCount + article.articleName.length + article.articleContent.length;
			})
